...
for (i in seq_along(epsilon)) {
  ...
  print(paste("Processing epsilon =", eps))
}

# How to access the result?
# How about save it to *csvs???
write.csv(E_mtx, file="Output_E_epsilon_Angambiae.csv", row.names =F)
write.csv(L_mtx, file="Output_L_epsilon_Angambiae.csv", row.names =F)
write.csv(N_mtx, file="Output_N_epsilon_Angambiae.csv", row.names =F)
write.csv(S_v_mtx, file="Output_S_v_epsilon_Angambiae.csv", row.names =F)
write.csv(E_v_mtx, file="Output_E_v_epsilon_Angambiae.csv", row.names =F)
write.csv(I_v_mtx, file="Output_I_v_epsilon_Angambiae.csv", row.names =F)
write.csv(V_mtx, file="Output_V_epsilon_Angambiae.csv", row.names =F)
write.csv(Prev_mtx, file="Output_Prev_epsilon_Angambiae.csv", row.names =F)
write.csv(Pos_mtx, file="Output_Pos_epsilon_Angambiae.csv", row.names =F)
